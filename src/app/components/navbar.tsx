...
export default function Nav() {
  ...
  return (
    <div className="flex items-center justify-between xl:justify-center xl:gap-120   h-20 p-2 px-6 border-b border-zinc-200">
      ...
      <div className="flex xl:gap-80">
        ...
        <div className="flex items-center xl:gap-10">
          ...
          <button
            className="bg-zinc-700 p-3 rounded-full text-zinc-50 "
          >
            contact me
          </button>
        </div>
