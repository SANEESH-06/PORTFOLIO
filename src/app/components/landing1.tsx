        ...
        <div className="w-full  md:mt-25 flex flex-col justify-center">
                        ...
                        >
                            ...
                            <div className=" flex flex-col xl:flex-row xl:gap-2 gap-5 xl:gap-8">
                                <div className=" flex   sm:mt-3 items-center">
                                    <br /><span className="">a</span>
                                    <span className="bg-zinc-800  mt-2 xl:ml-5 hover:scale-120 transition-[1000px] text-white rounded-full  px-7 sm:px-16 py-3  text-lg">
                                        Web-developer
                                    </span>
                                </div>
                                ...
                                <div className="items-center flex  flex-row">
                                    <span>from</span>
                                    <span className="bg-white ml-2 hover:scale-120 transition-[1000px] -mt-3 rounded-full border-1 px-3 py-3 mb- text-xl">
                                        Calicut
                                    </span>
                                </div>
                            </div>
                            ...
                            <span className="leading-14.5 -mt-2  xl:leading-19">transforming visions into digital realities with precision and flair.</span>
                        </div>
                    </div>
                </div>
            </div>
            <div className="flex  flex-col justify-center xl:ml-75">
                <div className="flex w-full flex-col md:flex-row mt-5 md:gap-49 xl:gap-40 md:items-center px- mb- ">
                    <span className="px-7 md:w-70 md:gap-10 font-bold flex">(2025 - PRESENT)</span>
